...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { codigo_fabricante: @producto.codigo_fabricante, descripcion: @producto.descripcion, modelo_id: @producto.modelo_id, unidad: @producto.unidad } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { codigo_fabricante: @producto.codigo_fabricante, descripcion: @producto.descripcion, modelo_id: @producto.modelo_id, unidad: @producto.unidad } }
