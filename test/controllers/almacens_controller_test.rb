...
class AlmacensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create almacen" do
    assert_difference('Almacen.count') do
      post almacens_url, params: { almacen: { encargado: @almacen.encargado, nombre: @almacen.nombre, ubicacion: @almacen.ubicacion } }
    end
  ...
  test "should update almacen" do
    patch almacen_url(@almacen), params: { almacen: { encargado: @almacen.encargado, nombre: @almacen.nombre, ubicacion: @almacen.ubicacion } }
